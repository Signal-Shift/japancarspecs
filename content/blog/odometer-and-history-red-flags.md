...
## Auction sheet and registration cues
...
## Listing and photo tells (non-definitive)

These are **hints**, not proof:

- **Shiny steering wheel rim** or **worn seat bolsters** on a “low km” car.
- **Mixed tyre dates** versus claimed storage or mileage story.
- **Inconsistent service stickers** or missing recent stamps versus the odometer arc.
- **Cluster swaps** visible in photos (aftermarket rings, mismatched illumination, warning-light gaps).
...
- Cross-check **chassis / frame** on the sheet, export paperwork, and listing.
- Align **auction house name, date, and lot** when a pack is advertised as “auction grade X.”
- Prefer **time-stamped evidence** over repeated copy-paste marketing text.
...
When mileage is **unknown**, **replaced**, or **contradicted** by condition, assume you need **more data or a lower price**, not a faster transfer. The cheapest time to discover a problem is **before** the car is on a boat with your name on the paperwork.
